...
Okay, so it looks like most of the birds were about 10 years old, but some were a lot older.
...
While some Orders seem to have more long-lived members (looking at you, Procellariiformes), most seem to top out around 30-40 years old.

Ideally, I want to track down some phylogenetic data and some bird size data so I can see if there are any other cool connections between the data.
